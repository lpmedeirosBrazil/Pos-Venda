...
module.exports = function (controller) {
    ...
    controller.hears( 'ajuda', 'message,direct_message', async ( bot, message ) => {

        let markDown = '**Comandos disponíveis:**  \n';
    ...
    controller.commandHelp.push( { command: 'ajuda', text: 'Monstra os comandos disponíveis' } );
}
